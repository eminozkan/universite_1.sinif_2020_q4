...
int main(){
    ...
    cin >> yourphone.area >> yourphone.exchange >> yourphone.number;

    cout << "My phone number is (" << myphone.area << ") " << myphone.exchange << '-' << myphone.number << endl;
    cout << "Your phone number is (" << yourphone.area << ") " << yourphone.exchange << '-' << yourphone.number << endl;
    return 0;
}
